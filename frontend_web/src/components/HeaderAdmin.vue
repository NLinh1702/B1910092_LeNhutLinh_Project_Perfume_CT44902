...
<template>
  <nav class="navbar navbar-expand-lg bg-secondary">
    <div class="container-fluid">
      <a class="navbar-brand" href="http://localhost:3001/admin" style="color: white"><img src="../assets/image/logo.jpg" alt="" style="width: 70px;"></a>
      ...
      <div class="collapse navbar-collapse" id="navbarScroll">
        <ul class="navbar-nav me-auto my-2 my-lg-0 navbar-nav-scroll" style="--bs-scroll-height: 100px;">
          <li class="nav-item">
            <a class="nav-link">
              <router-link to="/DSuser" class="text-white">DANH SÁCH NGƯỜI DÙNG</router-link>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link">
              <router-link to="/List_Product" class="text-white">DANH SÁCH SẢN PHẨM</router-link>
            </a>
          </li>
        </ul>
        <form class="d-flex" role="search">
         ...
         <div class="Cart">
           <div class="wrapper_cart">
             <i class="bi bi-cart-check-fill icon icon_cart"></i>
