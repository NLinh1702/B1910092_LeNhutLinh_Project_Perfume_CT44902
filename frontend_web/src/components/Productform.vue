                ...
                <div class="form-content">
                    <div class="form-items"> 
                        <Form :validation-schema="productform"  @submit="submitproduct" >
                           ...
                           <br>
                           <div class="col-md-12">
                              <span for="sizeproduct">Size (ml)</span>
                           ...
                           <div class="col-md-12">
                              <span for="sizeproduct">Mô tả</span>
                                <Field type="text" class="form-control" id="colorproduct" name="color"  placeholder="Mô tả sản phẩm" v-model="productLocal.color"/>
